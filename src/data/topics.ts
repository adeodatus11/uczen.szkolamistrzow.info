...
export const topics: Topic[] = [
  ...
  },
  {
    ...
    title: "Zebranie rodziców klas pierwszych (wrzesień 2026)",
    eyebrow: "Archiwum · 4 września 2026 r.",
    summary: "Pierwsze zebranie rodziców i opiekunów uczniów klas pierwszych odbyło się 4 września 2026 r. o godz. 16:00.",
    audiences: ["wszyscy", "rodzic"],
    tone: "neutral",
    important: "To informacja archiwalna. Zebranie odbyło się 4 września 2026 r. Najbliższe zebrania i konsultacje zaplanowano na 9 grudnia 2026 r.",
    facts: [
      "Zebranie dotyczyło rodziców i opiekunów uczniów klas pierwszych szkoły branżowej oraz technikum.",
      "Spotkanie odbyło się 4 września 2026 r. o godz. 16:00.",
      "Kolejne zebrania i konsultacje zaplanowano na 9 grudnia 2026 r.",
    ],
    actions: [
      "Sprawdź aktualne terminy w terminarzu portalu.",
      "Jeżeli nie mogłeś być na zebraniu, skontaktuj się z wychowawcą przez VULCAN-a.",
      "Sprawdzaj wiadomości w VULCAN-ie i oficjalne komunikaty szkoły.",
    ],
    sourceIds: ["school-start-2026", "zsz5-main"],
  },
  {
    slug: "zebranie-rodzicow-grudzien-2026",
    title: "Zebrania z rodzicami i konsultacje 9 grudnia",
    eyebrow: "Szkoła branżowa i technikum · 9 grudnia 2026 r.",
    summary: "9 grudnia 2026 r. o godz. 17:00 odbędą się zebrania z rodzicami uczniów klas 5 technikum oraz konsultacje dla pozostałych klas.",
    audiences: ["wszyscy", "rodzic"],
    tone: "yellow",
    important: "Spotkania zaczynają się 9 grudnia 2026 r. o godz. 17:00. Konsultacje dla pozostałych klas trwają do godz. 18:00.",
    facts: [
      "Wychowawcy klas 5 technikum prowadzą zebrania z rodzicami na zakończenie I półrocza.",
      "W pozostałych klasach wszyscy nauczyciele prowadzą konsultacje dla uczniów, w tym słuchaczy BS II st., i rodziców, w godzinach 17:00-18:00.",
      "W tym samym dniu wystawiane są oceny półroczne uczniom klas 5 technikum.",
      "Oceny śródroczne klas 1-4 technikum oraz klas 1-3 Branżowej Szkoły I stopnia są wystawiane 7 stycznia 2027 r.",
      "Informacja o salach i szczegółach organizacyjnych jest przekazywana w komunikacie szkoły lub w VULCAN-ie.",
    ],
    actions: [
      "Zapisz termin: 9 grudnia 2026 r., godz. 17:00.",
      "Sprawdź oceny i frekwencję w VULCAN-ie przed spotkaniem.",
      "Przygotuj pytania do wychowawcy albo do nauczyciela konkretnego przedmiotu.",
      "Sprawdź w komunikacie szkoły lub w VULCAN-ie informację o salach.",
    ],
    sourceIds: ["school-calendar-2026-2027", "zsz5-main"],
  },
  {
    slug: "karta-zdrowia",
