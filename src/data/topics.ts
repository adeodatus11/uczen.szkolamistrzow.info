...
export const topics: Topic[] = [
  ...
  },
  {
    ...
    eyebrow: "Szkoła branżowa i technikum · pierwszy tydzień września",
    summary: "Pierwsze zebranie rodziców i opiekunów klas pierwszych jest planowane w pierwszym tygodniu września 2026 r.",
    audiences: ["wszyscy", "rodzic"],
    tone: "yellow",
    important: "To bardzo ważne spotkanie organizacyjne. Dokładna data, godzina i miejsce zostaną podane później.",
    facts: [
      "Termin dotyczy rodziców i opiekunów uczniów klas pierwszych szkoły branżowej oraz technikum.",
      "Zebranie jest planowane w pierwszym tygodniu września 2026 r.",
      "Dokładna data, godzina i miejsce spotkania zostaną podane w późniejszym komunikacie.",
    ],
    actions: [
      "Sprawdzaj wiadomości w VULCAN-ie i oficjalne komunikaty szkoły.",
      "Po opublikowaniu szczegółów zapisz dokładny termin i miejsce spotkania.",
