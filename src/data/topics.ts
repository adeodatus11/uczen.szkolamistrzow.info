...
export const topics: Topic[] = [
  ...
  },
  {
    ...
    eyebrow: "Szkoła branżowa i technikum · 4 września 2026 r.",
    summary: "Pierwsze zebranie rodziców i opiekunów uczniów klas pierwszych odbędzie się 4 września 2026 r. o godz. 16:00.",
    audiences: ["wszyscy", "rodzic"],
    tone: "yellow",
    important: "Zebranie odbędzie się 4 września 2026 r. o godz. 16:00. To bardzo ważne spotkanie organizacyjne.",
    facts: [
      "Termin dotyczy rodziców i opiekunów uczniów klas pierwszych szkoły branżowej oraz technikum.",
      "Zebranie odbędzie się 4 września 2026 r. o godz. 16:00.",
      "Informacja o miejscu spotkania zostanie przekazana w osobnym komunikacie szkoły lub w VULCAN-ie.",
    ],
    actions: [
      "Sprawdzaj wiadomości w VULCAN-ie i oficjalne komunikaty szkoły.",
      "Zapisz termin: 4 września 2026 r., godz. 16:00.",
      "Sprawdź w komunikacie szkoły lub w VULCAN-ie informację o miejscu spotkania.",
