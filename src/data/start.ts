...
export const startNotices: StartNotice[] = [
  ...
  {
    day: "I",
    month: "tydzień września 2026",
    audience: "Oba typy szkół",
    title: "Zebranie rodziców klas pierwszych",
    description: "To bardzo ważne spotkanie organizacyjne dla rodziców i opiekunów uczniów klas pierwszych.",
    action: "Dokładna data, godzina i miejsce zostaną podane później.",
